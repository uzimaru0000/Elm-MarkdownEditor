...
var _user$project$Model$init = {
	...
	_1: A2(
		_elm_lang$core$Task$perform,
		_user$project$Model$GetWindowSize,
		A3(_elm_lang$core$Task$map2, _elm_lang$window$Window$Size, _elm_lang$window$Window$width, _elm_lang$window$Window$height))
};
var _user$project$Model$TextInput = function (a) {
		...
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Model$TextInput),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('planeText'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('mdArea'),
						_1: {ctor: '[]'}
					},
					model.plane),
				_1: {ctor: '[]'}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Model.Msg":{"args":[],"tags":{"TextInput":["String"],"GetWindowSize":["Window.Size"],"NoOp":[]}}},"aliases":{"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"}},"message":"Model.Msg"},"versions":{"elm":"0.18.0"}});
}
